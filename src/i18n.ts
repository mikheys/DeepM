...
const en: Strings = {
  ...
  ocr_engine_tesseract: "Tesseract (built-in, recommended)",
...
const ru: Strings = {
  ...
  ocr_engine_tesseract: "Tesseract (встроенный, рекомендуется)",
